...
import { initBrowser, runUiTest } from "src/utils";
...
export default function Ui() {
  ...
  const onCaptureClicked = useCallback(async () => {
    try {
      await initBrowser();
      toast.success("Browser intialized successfully");
    } catch (error) {
      console.log(error);
      toast.error("Browser initialization failed!");
    }
  }, []);
